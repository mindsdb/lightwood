...
class Predictor(PredictorInterface):
    ...
    def prepare(self, data: Dict[str, pd.DataFrame]) -> None:
        ...
        self.encoders = {
            "price": Integer.NumericEncoder(
                is_target=True,
                positive_domain=self.statistical_analysis.positive_domain,
            ),
            "model": LabelEncoder.MyLabelEncoder(),
            "year": Integer.NumericEncoder(),
            "transmission": LabelEncoder.MyLabelEncoder(),
            "mileage": Integer.NumericEncoder(),
            "fuelType": LabelEncoder.MyLabelEncoder(),
            "tax": Integer.NumericEncoder(),
            "mpg": Float.NumericEncoder(),
            "engineSize": Float.NumericEncoder(),
        }
