class dtype:
    ...
    - **Array**: Data in the form of a sequence where order must be preserved. A ``ts_`` prefix means that the column is not made up of arrays but will be transformed to arrays at a row-level because it shall be treated as a time series.
