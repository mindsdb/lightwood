...
class DefaultNet(torch.nn.Module):
    ...
    def __init__(self, ds, dynamic_parameters, shape=None, selfaware=False, size_parameters={}, pretrained_net=None):
        ...
        if shape is None and pretrained_net is None:
            ...
            '''
            shape = [self.input_size, max([self.input_size*2,self.output_size*2,400]), max([self.input_size*2,self.output_size*2,400]), max([self.input_size*2,self.output_size*2,400]), self.output_size]
