"""
If in future we want to add some special logic for boosting models
then we can remove boosting regressor & classifier from SklearnMixer
and uncomment the BoostMixer below
"""
